...
public class FailureAnalysis
{
     ...
     */
    public FailureAnalysis(FailureType type, String title, String detail, Exception cause) {
    ...
    public static final class Builder
    {
        ...
        public Builder(FailureAnalysis initialData)
        {
        ...
        public FailureAnalysis build()
        {
           ...
           // determine what has been overridden to simplify the later decision code
            ...
            return new FailureAnalysis(this.type, this.title, this.detail, this.cause);
        }
